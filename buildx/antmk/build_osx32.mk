...
build_opt_c        = -m32 -g -Wall -Wextra -Wdeclaration-after-statement -nostdinc -ffreestanding -fno-stack-check -fno-stack-protector -mno-stack-arg-probe -O3 -DXI_BUILD_${build_cfg_target} -D_REENTRANT -D_THREAD_SAFE -DMACOSX
build_opt_cxx      = -m32 -g -Wall -Wextra -nostdinc -ffreestanding -fno-stack-check -fno-stack-protector -mno-stack-arg-probe  -O3 -DXI_BUILD_${build_cfg_target} -D_REENTRANT -D_THREAD_SAFE -DMACOSX
build_opt_fPIC     = -fPIC
build_opt_ld       = -m32 -g -Wl,--no-undefined -nostdlib
...
build_xb_libc_cmn_ldflags = -nostdlib
...
# libdl.so
####
build_xb_libdl_bin        = libdl.dylib
build_xb_libdl_cflags     = ${build_xb_libc_cmn_cflags}
build_xb_libdl_ldflags    = 
...
# libc.so
####
build_xb_libc_lcs_bin     = libc.dylib
...
####
build_xb_libc_mdl_bin     = c_malloc_debug_leak.dylib
...
####
build_xb_libc_mdq_bin     = c_malloc_debug_qemu.dylib
...
# libm.so
####
build_xb_libm_so_bin       = libm.dylib
...
# libstdc++.so
####
build_xb_libscx_so_bin     = libstdc++.dylib
...
# libthread_db.so
####
build_xb_libtdb_so_bin     = libthread_db.dylib
